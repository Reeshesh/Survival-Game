...
public class CraftingSystem : MonoBehaviour
{
    ...
    public GameObject toolsScreenUI, refineScreenUI, constructionScreenUI;

    public List<string> inventoryItemList = new List<string>();

    //Category Buttons
    Button toolsBTN, refineBTN, constructionBTN;
    ...
    public Blueprint PlankBLP = new Blueprint("Plank", 3, 1, "Log", 1, "", 0);
